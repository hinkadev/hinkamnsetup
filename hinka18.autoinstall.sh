#!/bin/bash
# HINKA Masternode Setup Script V1 for Ubuntu 18.04 LTS
#
...
wget https://github.com/hinkadev/hinkacore/releases/download/v1.0.1/hinka-ubuntu18-daemon-1.0.1.tgz
tar -xvf hinka-ubuntu18-daemon-1.0.1.tgz
